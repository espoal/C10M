...
The first time a user visits our website the client cache will be empty, and we will have to serve a big payload containing a SSR version of the page and all the assets. We could exploit Google AMP and the amp-install-serviceworker tag to 
</p>
...
#### HTTP/3
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MzkyODUzOTEsMTkxNjg2MTk2OSwxNT
